/*
//TODO
Functions affected with SVG incompatibility
clone
* */
	...
	return function(classNames) {
		if ($.isFunction(classNames)) {
			return this.each(function(i) {
				$(this).addClass(classNames.call(this, i, classes(this)));
			});
		}
		...
		return this.each(function() {
			if ($.svg.isSVGElem(this)) {
				...
				$.each(classNames.split(/\s+/), function(i, className) {
					var classes = classes(node);
					if ($.inArray(className, classes.split(/\s+/)) === -1) {
						classes(node,  classes += (classes ? ' ' : '') + className);
					}
				});
			}
			else {
...
$.fn.removeClass = function(origRemoveClass) {
	return function(classNames) {
		if ($.isFunction(classNames)) {
			return this.each(function(i) {
				$(this).removeClass(classNames.call(this, i, classes(this)));
			});
		}
		var origArgs = arguments;
		classNames = classNames || '';
...
$.fn.toggleClass = function(origToggleClass) {
	return function(classNames, state) {
		if ($.isFunction(classNames)) {
			return this.each(function(i) {
				$(this).toggleClass(classNames.call(this, i, classes(this), state), state);
			});
		}
		var origArgs = arguments;
		...
		return this.each(function() {
			if ($.svg.isSVGElem(this)) {
				if (typeof classNames === 'string') {
					...
					classes(this, classes || classNames === false ? '' : $._data(this, '__className__') || '');
				}
			}
			else {
...
$.fn.hasClass = function(origHasClass) {
	return function(className) {
		...
		this.each(function() {
			if ($.svg.isSVGElem(this)) {
				found = ($.inArray(className, classes(this).split(/\s+/)) > -1);
			}
			else {
